  ...
  return (
    <div>
      <nav className="navbar navbar-dark bg-dark navbar-expand-lg" >
        ...
        <button className="navbar-toggler" type="button" type="button" data-toggle="collapse" data-target="#navbarTop" aria-controls="navbar" aria-expanded="false" aria-label="Toggle navigation">
